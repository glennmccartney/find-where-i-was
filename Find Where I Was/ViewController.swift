...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, GADInterstitialDelegate {
                    ...
                    UMPConsentInformation.sharedInstance.requestConsentInfoUpdate(
                        ...
                        completionHandler: { [self] error in
                            ...
                            if error != nil {
                                ...
                                if formStatus == UMPFormStatus.unavailable {
                ...
                if UMPConsentInformation.sharedInstance.consentStatus == UMPConsentStatus.required {
                    form?.present(
                        ...
                        completionHandler: { dismissError in
                            ...
                            if UMPConsentInformation.sharedInstance.consentStatus == UMPConsentStatus.notRequired {
                                // App can start requesting ads.
                                self.interstitial = self.createAndLoadInterstitial()
                            }
                    ...
                    //UMPConsentInformation not required, so start showing ads
                    self.interstitial = self.createAndLoadInterstitial()
                }
    ...
    func findUserLocation()
    {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            self.statusLabel.text = "Searching For Your Location..."
        }
    }
